...
const staticLeaders = [
  {
    ...
    email: '1902296058@qq.com',
    department: '软件工程（智能物联）',
    bio: '学生负责人，专注于嵌入式开发与边缘ai',
    avatar: '/images/team/tangchenxiang.jpg',
    github_url: 'https://github.com/tcx101',
    skills: ['嵌入式开发', 'STM32', '物联网'],
    grade: '',
    phone: '',
    motivation: '',
    status: 'approved' as const,
  ...
  },
  {
    ...
    name: '郭响雨',
    role: 'leader' as const,
    email: 'guoxiangyu@example.com',
    department: '软件工程（智能物联）',
    bio: '学生负责人，专注于嵌入式开发与智能控制',
    avatar: '/images/team/guoxiangyu.jpg',
    github_url: '',
    skills: ['pid算法', '嵌入式开发', 'STM32'],
    grade: '',
    phone: '',
    motivation: '',
    status: 'approved' as const,
